    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="
            block w-full pl-10 pr-10 py-3 border border-gray-200 rounded-2xl
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {selectedTags.map((tag) => (
          <span
            key={tag}
            className={`
              inline-flex items-center gap-1 px-3 py-1 rounded-xl text-sm font-medium
        ...
        {availableTags.length > selectedTags.length && (
          <div className="relative tag-dropdown-container">
            <button
              ...
              className="
                inline-flex items-center gap-1 px-3 py-1 rounded-xl text-sm
